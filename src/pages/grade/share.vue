...
<script>
  ...
  import { getReport, getShareCard } from '../../utils/api'
  ...
  export default {
    ...
    methods: {
      ...
      join() {
        ...
        // }
        uni.redirectTo({
          url: `/pages/home/index?categoryId=${this.joinParam.categoryId}&subjectId=${this.joinParam.subjectId}&areaId=${
            this.joinParam.areaId
          }&name=${encodeURIComponent(this.joinParam.name)}&tabType=estimate`
        })
      },
